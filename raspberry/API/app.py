...
def list_ports():
    ...
    port_list = [{"device": p.device, "description": p.description} for p in sorted(ports)]
...
if __name__ == '__main__':
    ...
    print("Available new endpoints: GET /list_ports, POST /connect, POST /disconnect, GET /status")
