...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.url_input = QLineEdit("http://127.0.0.1:5000")
        ...
        conn_layout.addWidget(btn_refresh_ports, 1, 2)
    ...
    def toggle_connection(self):
        if not self.dev.is_connected:
            ...
            if not port:
                ...
                return
            try:
                self.dev.base_url = self.url_input.text().strip().rstrip('/')
